...
namespace Micro.Auth.Api.Internal.StartupExtensions
{
    public static class Identity
    {
        ...
        private static void ConfigureAuthentication(this IServiceCollection services, IdentityConfig identityConfig)
        {
            ...
            }).AddJwtBearer(config => { ConfigureJwtBearer(services, config, identityConfig); });
        }
            ...
            where TRole : class
        {
            services.AddAuthentication(options =>
                ...
                {
                    o.LoginPath = new PathString("/api/session/new");
        ...
        private static void AddStores(IServiceCollection services, Type userType, Type roleType, Type contextType)
        {
            ...
            if (identityUserType == null) throw new InvalidOperationException("Not an identity user");
            ...
            if (roleType != null)
            {
                ...
                if (identityRoleType == null) throw new InvalidOperationException("Not an identity role");
